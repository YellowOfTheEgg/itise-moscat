...
if __name__ == "__main__":
    ...
    # evol_clusterings = run_clusterings(data, data_definition,init_point_set,max_iter_set=max_iter_set, k_set=k_set, weight_set=weight_set)

    evol_clusterings = []
    for k in tqdm(k_set, desc="k", position=0):

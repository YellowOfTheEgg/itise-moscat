...
class Moscat:  #
    ...
    def calculate_init_params(self, data):
        init_parameters = []
        for clustering_params in tqdm(
            self.clustering_method.input_parameters,
            desc="Moscat: initialization",
            leave=False,
        ):
    ...
    def calculate_optimal_parameters(self, data):
        ...
        for time in tqdm(
            times[1:], desc="Moscat: total progress", position=5, leave=False
        ):

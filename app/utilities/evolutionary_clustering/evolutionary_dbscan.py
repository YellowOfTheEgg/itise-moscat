...
from app.moscat.interfaces.snapshot_quality_measures import (
    DBVCScore,
...
class EvolDBSCAN:
    ...
    def fit(self, timeseries_data):
        ...
        for t in tqdm(times, desc="Clustering Progress"):
            clusterings = []
    ...
    def select_clustering_over_time(self, weight):
        ...
        for i, timepoint_clusterings in enumerate(
            tqdm(self.clusterings_over_time, desc="Selecting Clusterings")
        ):

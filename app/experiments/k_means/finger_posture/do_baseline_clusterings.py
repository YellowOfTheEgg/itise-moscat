...
def do_baseline_clustering(
    data, data_definition, init_point_index, k, max_iter_set, halflife
):
    ekmeans = EvolIncrementalKmeans(
        k, init_point_index, max_iter=max(max_iter_set), cp=0, halflife=halflife
    )
